...
API_ID = int(environ.get('API_ID', '29162926'))
API_HASH = environ.get('API_HASH', '717d5ca64b70f7a8b3d2e2ceac60c3e0')
BOT_TOKEN = environ.get('BOT_TOKEN', "7354665689:AAHd1BXZDJ30xhniy686zmXMoWkbfBQFBTo")


# This Pictures Is For Start Message Picture, You Can Add Multiple By Giving One Space Between Each.
PICS = (environ.get('PICS', 'https://i.ibb.co/q3rVdnKd/image-1.jpg')).split()


# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7613114681').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002695513443'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002287320170').split()]  # For Multiple Id Use One Space Between Each.
...
reqst_channel = environ.get('REQST_CHANNEL', '-1002541438888')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002557170153')).split()]  # For Multiple Id Use One Space Between Each.
...
PAYMENT_QR = environ.get('PAYMENT_QR', 'https://i.ibb.co/q3rVdnKd/image-1.jpg') # payment code picture url.
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("URL", "https://tall-merla-iimaansrk-f15e617c.koyeb.app/")
